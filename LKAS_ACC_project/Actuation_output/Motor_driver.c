...
/*-----------------------------------------------Function Prototypes-------------------------------------------------*/
/*********************************************************************************************************************/
void setDutyCycleA(uint32 dutyCycle);                                /* Function to set the duty cycle of the PWM    */
void setDutyCycleB(uint32 dutyCycle);                                /* Function to set the duty cycle of the PWM    */
